...
export declare type PostType = 'get_status' | 'get_segmentation' | 'get_template' | 'get_service_sector' | 'get_contact' | 'get_prot' | 'put_contact' | 'set_contact' | 'send_text' | 'send_image' | 'send_file' | 'send_sound';
